/**
 * Pages - Http Error Node
 */

/* Imports */

import type { HttpErrorText } from './HttpErrorNodeTypes'
 ...
 */
const HttpErrorNode = async (type: number = 404, returnData: boolean = false): Promise<RenderItem | string> => {
  /* Text by type */
