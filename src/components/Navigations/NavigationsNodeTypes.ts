/**
 * Components - Navigations Node Types
 */
...
/**
 * @typedef {function} NavigationsNodeObj
 * @param {NavigationProps} props
 * @return {GenericStrings}
 */
export type NavigationsNodeObj = (props: NavigationProps) => GenericStrings

/**
 * @typedef {function} NavigationNodeFunc
 * @param {GenericStrings} navigations
 * @return {string} HTML
 */
export type NavigationNodeFunc = (navigations: GenericStrings) => string
